...
assert.deepEqual(zhRecord, {
  ...
  coreMeaningZh: zhCard.coreMeaningZh,
  coreMeaningEn: zhCard.coreMeaningEn,
  visibleLine: zhCard.visibleLineZh,
  visibleLineZh: zhCard.visibleLineZh,
  visibleLineEn: zhCard.visibleLineEn,
  hiddenLine: zhCard.hiddenLineZh,
  hiddenLineZh: zhCard.hiddenLineZh,
  hiddenLineEn: zhCard.hiddenLineEn,
  reflectionQuestions: zhCard.reflectionQuestionsZh,
  reflectionQuestionsZh: zhCard.reflectionQuestionsZh,
  reflectionQuestionsEn: zhCard.reflectionQuestionsEn,
  actionSeeds: zhCard.actionSeedsZh,
  actionSeedsZh: zhCard.actionSeedsZh,
  actionSeedsEn: zhCard.actionSeedsEn,
  prohibitedClaims: zhCard.prohibitedClaimsZh,
  prohibitedClaimsZh: zhCard.prohibitedClaimsZh,
  prohibitedClaimsEn: zhCard.prohibitedClaimsEn,
  label: "我的状态",
  position: "state",
...
assert.deepEqual(enRecord, {
  ...
  coreMeaningZh: enCard.coreMeaningZh,
  coreMeaningEn: enCard.coreMeaningEn,
  visibleLine: enCard.visibleLineEn,
  visibleLineZh: enCard.visibleLineZh,
  visibleLineEn: enCard.visibleLineEn,
  hiddenLine: enCard.hiddenLineEn,
  hiddenLineZh: enCard.hiddenLineZh,
  hiddenLineEn: enCard.hiddenLineEn,
  reflectionQuestions: enCard.reflectionQuestionsEn,
  reflectionQuestionsZh: enCard.reflectionQuestionsZh,
  reflectionQuestionsEn: enCard.reflectionQuestionsEn,
  actionSeeds: enCard.actionSeedsEn,
  actionSeedsZh: enCard.actionSeedsZh,
  actionSeedsEn: enCard.actionSeedsEn,
  prohibitedClaims: enCard.prohibitedClaimsEn,
  prohibitedClaimsZh: enCard.prohibitedClaimsZh,
  prohibitedClaimsEn: enCard.prohibitedClaimsEn,
  label: "Relation",
  position: "relation",
